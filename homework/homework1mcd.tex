...
\paragraph{c} \framebox{\parbox{\textwidth}{The probabilities for the desired correlated equilibrium are found in Table \ref{tab:3c}.}} To find this equilibrium we must consider, for each possible action recommended to the player by the mediator:
\begin{enumerate}
